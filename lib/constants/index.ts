export const APP_NAME =
  process.env.NEXT_PUBLIC_APP_NAME || "Malminas Traditional studio";
export const COPYRIGHT_HOLDER = "Malmina's Traditional studio Pk.";
export const APP_DESCRIPTION =
  process.env.NEXT_PUBLIC_APP_DESCRIPTION ||
  "A modern e-commerce store built with Next.js";
export const SERVER_URL =
  process.env.NEXT_PUBLIC_SERVER_URL || "http://localhost:3001";
export const PRIMARY_COLOR = process.env.NEXT_PUBLIC_PRIMARY_COLOR || "#8A7B20";
export const LATEST_PRODUCTS_LIMIT =
  Number(process.env.LATEST_PRODUCTS_LIMIT) || 40;
